const debug = (...msg) => { // eslint-disable-line no-unused-vars
...
export default class CacxParser {
	...
	*/
	settings = {
		...
		onAttr: (key, val, options) => ({ // eslint-disable-line no-unused-vars
			[key]: isFinite(val) ? +val // eslint-disable-line unicorn/prefer-number-properties
